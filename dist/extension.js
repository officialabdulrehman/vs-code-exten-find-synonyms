...
class StaticFileService {
    ...
    setTitleCapital(title) {
        this._titleSmall = (0, common_1.capitallizeFirstLetter)(title);
    }
    create({ folderPath, filePath, fileContent, fileIPath, fileIContent }) {
        (0, fs_1.mkdirSync)(folderPath, { recursive: true });
        (0, fs_1.appendFileSync)(filePath, fileContent);
        if (fileIPath && fileIContent) {
            (0, fs_1.appendFileSync)(fileIPath, fileIContent);
        }
    }
    loadTemplates() {
        this.setDTO();
